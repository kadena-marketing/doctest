...
<head>
  <title>Kadena REST API</title>
  <meta name="description" content="The Kadena REST API consists of three main types of API endpoints. The Pact API provides endpoints for interacting with smart contracts, including signing, submitting, and checking transactions. The peer-to-peer (P2P) API provides endpoints for nodes to communicate with each other. The service API provides endpoints for querying and interacting with nodes from clients outside of the blockchain network." />
</head>
...
- [State cut height endpoints](/reference/chainweb-api/cut)
...
For more information about Pact endpoints, see the [Pact API](/reference/rest-api).
...
You can view the [data models](./data-models) for the following Chainweb node features.

- [Cut data](./data-models#cut-model)
- [Block header](./data-models#block-header-model)
- [Payload](./data-models#payload-model)
- [Payload with outputs](./data-models#payload-with-outputs-model)
- [Peer information](./data-models#peer-information-model)
- [Chainweb node information](./data-models#chainweb-node-information-model)
- [Collection page](./data-models#collection-page-model)
- [Miner information](./data-models#miner-information-model)
- [Mining update event stream](./data-models#mining-update-event-stream-model)

## Binary encoding

For technical details about binary encoding and calculated values, see [Binary encoding](./binary-encoding).
